  ...
  return (
    <div className="">
      <Head>
        ...
        <meta property="og:url" content="https://cheeky.tools/tools/sha512" />
        <meta property="og:description" content="This Sha-512 hash generator is a hashing tool for encoding strings, personal data and other information into databases and storage." />
      ...
      <div className="">
        ...
        <p className='mt-5'>Quickly compute the Sha-512 hash of any string. Other hashing tools can be found here.</p>
      </div>
      <div className="my-3">  
        <div className="flex justify-between">
          ...
          <div className="flex gap-2">
            ...
            <div onClick={() => setInputString('')} className={`text-red-500 ${inputString.length > 0 ? 'block' : 'hidden'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
