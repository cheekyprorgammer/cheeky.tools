  ...
  return (
    <div className="">
      ...
      <div className="">
        ...
        <p className='mt-5'>Quickly compute the Sha-1 hash of any string. Other hashing tools can be found <Link href="/tools/hashing"><span className="text-blue-500 hover:text-blue-200 cursor-pointer">here</span></Link>.</p>
      </div>
      <div className="my-3">  
