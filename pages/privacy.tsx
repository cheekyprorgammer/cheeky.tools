...
const Privacy: NextPage = () => {
  return (
    ...
    <p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to www.website.com and other sites on the internet. However, visitors may choose to decline the use of DART cookies by visiting the Google ad and content network Privacy Policy <a href="https://policies.google.com/technologies/ads">here</a>.</p>
    ...
    <h2 className="text-2xl font-medium">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
