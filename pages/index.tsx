...
const Home: NextPage = () => {
  ...
  return (
    <div className="cursor-default">
      <Head>
        <title>Fast SEO Tools - Fast and Ready SEO Tools</title>
      ...
      <div className="">
        ...
        <p className="text-xl mb-3 italic">Fast and Ready SEO Tools.</p>
        <p className="mb-3">Built from scratch using enterprise level Javascript framework NEXT.js and deployed on the cutting edge Vercel content delivery network. Always online. Always ready.</p>
