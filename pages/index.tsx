...
const Home: NextPage = () => {
  return (
    <div className="">
      ...
      <div className="mx-auto p-5 lg:max-w-7xl md:items-center md:px-8">
        <h1 className="text-3xl underline">Welcome to cheeky.tools</h1>
        <p className="">Fast. Compact. Cheeky.</p>
        <p className="mt-2">A set of tools designed to help you live a better, and cheeky, life.</p>
