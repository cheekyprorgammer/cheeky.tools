...
export default function Sha256() {
    ...
    return <>
        ...
        <meta property="og:description" content="This SHA-256 (Secure Hashing Algorithm) hash generator is a hashing tool for encoding strings, personal data and other information into databases and storage." />
      ...
      <div className="">
        ...
        <p className='mt-5'>Quickly compute the SHA-256 hash of any string. Other hashing tools can be found <Link href="/tools/text"><span className="text-blue-500 hover:text-blue-200 cursor-pointer">here</span></Link>.</p>
      </div>
      <div className="my-3">  
