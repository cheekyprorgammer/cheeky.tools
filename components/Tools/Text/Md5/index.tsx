...
export default function Md5() {
    ...
    function calculateMd5() {
      ...
      if (inputString === "") {
        ...
        const newHash = md5hash(inputString)
    ...
    return <>
        <Head>
          ...
          <h1 className="text-center text-2xl font-bold underline">md5 Hash Generator</h1>
          <p className="mt-5">Quickly compute the MD5 hash of any string. Other hashing tools can be found <Link href="/tools/text"><span className="text-blue-500 hover:text-blue-200 cursor-pointer">here</span></Link>.</p>
