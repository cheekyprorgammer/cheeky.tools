...
export default function Sha512() {
    ...
    function calculateSha512() {
      ...
      if (inputString === "") {
        ...
        const newHash = hash.sha512().update(inputString).digest('hex')
    ...
    return <>
        <Head>
        <title>SHA-512 Hash Generator - cheeky.tools</title>
        <meta name="description" content="This SHA-512 hash generator is a hashing tool for encoding strings, personal data and other information into databases and storage." />
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content="SHA-512 Hash Generator" />
        <meta property="og:site_name" content="cheeky.tools" />
        <meta property="og:url" content="https://cheeky.tools/tools/text/sha256" />
        <meta property="og:description" content="This SHA-512 (Secure Hashing Algorithm) hash generator is a hashing tool for encoding strings, personal data and other information into databases and storage." />
        <meta property="og:type" content="website" />
        <meta property="og:image" content="https://cheeky.tools/cryptography.jpg" />
      </Head>
      <div className="">
        <h1 className="text-center text-5xl font-bold underline">SHA-512 Hash Generator</h1>
        <p className='mt-5'>Quickly compute the SHA-512 hash of any string. Other hashing tools can be found <Link href="/tools/text"><span className="text-blue-500 hover:text-blue-200 cursor-pointer">here</span></Link>.</p>
      </div>
      <div className="my-3">  
      ...
      <div className="mb-5 mt-8">
        <label htmlFor="output" className="block text-sm font-medium text-gray-900 dark:text-gray-300">Your SHA-512 Hash</label>
      ...
      <p className="text-sm"><span className="font-bold underline uppercase">Note:</span> All content generated by this tool is done client-side (on your local computer) using JavaScript. None of your data is recorded or stored by us at all. Please view our <span className="text-blue-500"><Link href="/privacy">Privacy Policy</Link></span> for more information.</p>
